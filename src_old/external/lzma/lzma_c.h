...
namespace plz
{
    namespace c
    {
        ...
        //C
        #include "liblzma/common/alone_decoder.c"
        #include "liblzma/common/alone_encoder.c"
        #include "liblzma/common/auto_decoder.c"
        #include "liblzma/common/block_buffer_decoder.c"
        #include "liblzma/common/block_buffer_encoder.c"
        #include "liblzma/common/block_decoder.c"
        #include "liblzma/common/block_encoder.c"
        #include "liblzma/common/block_header_decoder.c"
        #include "liblzma/common/block_header_encoder.c"
        #include "liblzma/common/block_util.c"
        #include "liblzma/common/common.c"
        #include "liblzma/common/easy_buffer_encoder.c"
        #include "liblzma/common/easy_decoder_memusage.c"
        #include "liblzma/common/easy_encoder.c"
        #include "liblzma/common/easy_encoder_memusage.c"
        #include "liblzma/common/easy_preset.c"
        #include "liblzma/common/filter_buffer_decoder.c"
        #include "liblzma/common/filter_buffer_encoder.c"
        #include "liblzma/common/filter_common.c"
        #include "liblzma/common/filter_decoder.c"
        #include "liblzma/common/filter_encoder.c"
        #include "liblzma/common/filter_flags_decoder.c"
        #include "liblzma/common/filter_flags_encoder.c"
        #include "liblzma/common/hardware_cputhreads.c"
        #include "liblzma/common/hardware_physmem.c"
        #include "liblzma/common/index.c"
        #include "liblzma/common/index_decoder.c"
        #include "liblzma/common/index_encoder.c"
        #include "liblzma/common/index_hash.c"
        #include "liblzma/common/outqueue.c"
        #include "liblzma/common/stream_buffer_decoder.c"
        #include "liblzma/common/stream_buffer_encoder.c"
        #include "liblzma/common/stream_decoder.c"
        #include "liblzma/common/stream_encoder.c"
        #include "liblzma/common/stream_encoder_mt.c"
        #include "liblzma/common/stream_flags_common.c"
        #include "liblzma/common/stream_flags_decoder.c"
        #include "liblzma/common/stream_flags_encoder.c"
        #include "liblzma/common/vli_decoder.c"
        #include "liblzma/common/vli_encoder.c"
        #include "liblzma/common/vli_size.c"
        ...
        //C
        #include "liblzma/lzma/fastpos_table.c"
        #include "liblzma/lzma/fastpos_tablegen.c"
        #include "liblzma/lzma/lzma2_decoder.c"
        #include "liblzma/lzma/lzma2_encoder.c"
        #include "liblzma/lzma/lzma_decoder.c"
        #include "liblzma/lzma/lzma_encoder.c"
        #include "liblzma/lzma/lzma_encoder_optimum_fast.c"
        #include "liblzma/lzma/lzma_encoder_optimum_normal.c"
        #include "liblzma/lzma/lzma_encoder_presets.c"
